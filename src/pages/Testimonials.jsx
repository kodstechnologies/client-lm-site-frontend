               ...
               <div className="section section-padding customer-review-area bg-color-dark overflow-hidden">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-4">
                                <div className="review-site-logo">
                                    <a href="https://www.facebook.com/"><img src={PUBLIC_URL + "/images/icon/fb.png"} alt="Facebook" /></a>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                ...
                <div className="section section-padding customer-review-area">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-4">
                                <div className="review-site-logo">
                                    <a href="https://www.yelp.com/"><img src={PUBLIC_URL + "/images/icon/yelp.png"} alt="Yelp" /></a>
                                </div>
                            </div>
                        </div>
                        <div className="row">
