                ...
                <div className="error-page onepage-screen-area">
                    <div className="container">
                        ...
                        <AnimationOnScroll  animateIn="slideInUp" duration={1} delay={300} animateOnce={true}>
                            <div className="content">
                                ...
                                <Link to={PUBLIC_URL + "/"} className="axil-btn btn-fill-primary">Go Back</Link>
                            </div>
                        </AnimationOnScroll>
                        </div>
                        <div className="col-lg-6">
                        <AnimationOnScroll  animateIn="zoomIn" duration={1} delay={300} animateOnce={true}>
                            <div className="thumbnail">
                                <img src={PUBLIC_URL + "/images/others/404.png"} alt="404" />
                            </div>
                        </AnimationOnScroll>
                        </div>
                        </div>
                    ...
                    <ul className="shape-group-8 list-unstyled">
                        ...
                        <li className="shape shape-2">
                            <img src={PUBLIC_URL + "/images/others/bubble-27.png"} alt="Bubble" />
                        </li>
