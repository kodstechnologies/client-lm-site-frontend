                ...
                <div className="coming-soon-area onepage-screen-area">
                    <div className="container">
                        ...
                        <div className="col-12">
                            <div className="site-logo">
                                <Link to={PUBLIC_URL + "/"} className="logo-light"><img src={PUBLIC_URL + "/images/logo-2.svg"} alt="Logo" /></Link>
                                <Link to={PUBLIC_URL + "/"} className="logo-dark"><img src={PUBLIC_URL + "/images/logo-3.svg"} alt="Logo" /></Link>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-6">
                            <div className="thumbnail">
                                <img src={PUBLIC_URL + "/images/others/coming-soon.png"} alt="Coming Soon" />
                            </div>
                        </div>
                        </div>
                    </div>
                    <ul className="shape-group-8 list-unstyled">
                        <li className="shape shape-2">
                            <img src={PUBLIC_URL + "/images/others/bubble-28.png"} alt="Bubble" />
                        </li>
