                ...
                <div className="container">
                    ...
                    <div className="about-expert">
                        <div className="thumbnail">
                            <img src={PUBLIC_URL + "/images/about/about-1.png"} alt="Thumbnail" />
                            <div className="popup-video">
                                <button className="play-btn" onClick={ () => setToggler(!toggler) }><FaPlay /></button>
                            </div>
                        </div>
                        <ul className="frame-shape list-unstyled">
                            <li className="shape shape-1"><img src={PUBLIC_URL + "/images/about/frame-1.png"} alt="Frame" /></li>
                            <li className="shape shape-2"><img src={PUBLIC_URL + "/images/about/frame-2.png"} alt="Frame" /></li>
                        </ul>
                    </div>
                </div>
