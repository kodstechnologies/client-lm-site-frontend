                    ...
                    <div className={`case-study-featured-thumb thumb-${data.id}`}>
                        <div className='container'>
                            ...
                            <Tilty perspective={2000}>
                                <img src={PUBLIC_URL + data.thumb} alt="Case Study" />
                            </Tilty>
                        </div>
                    </div>
                </div>
                <div className="col-xl-5 col-lg-6 offset-xl-1">
                    ...
                    <div className="case-study-featured">
                        <div className="section-heading heading-left">
                            ...
                            {/* <Link to={PUBLIC_URL + `/case-details/${slugify(data.title)}`} className="axil-btn btn-fill-primary btn-large">Read Case Study</Link> */}
                        </div>
