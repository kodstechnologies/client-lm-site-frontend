...
const BannerThree = () => {
    return (
                ...
                <div className="col-lg-6">
                    <div className="banner-content">
                        ...
                        <div className="btn-group">
                            ...
                            <Link to={PUBLIC_URL + "/about-us"} className="about-btn">About Me</Link>
                        </div>
                        </AnimationOnScroll>
                    </div>
                </div>
                    ...
                    <div className="large-thumb">
                        <AnimationOnScroll  animateIn="slideInUp" duration={1} animateOnce={true} delay={200}>
                            <Tilty perspective={2000} reset={false}>
                                <img src={PUBLIC_URL + "/images/banner/banner-thumb-6.png"} alt="Shape" />
                            </Tilty>
                        </AnimationOnScroll>
                    </div>
                    </div>
            ...
            <ul className="list-unstyled shape-group-20">
                ...
                <img src={PUBLIC_URL + "/images/others/bubble-32.png"} alt="Bubble" />
                </li>
                <li className="shape shape-2">
                <img src={PUBLIC_URL + "/images/others/bubble-33.png"} alt="Bubble" />
                </li>
                <li className="shape shape-4">
                <img src={PUBLIC_URL + "/images/others/bubble-14.png"} alt="Bubble" />
                </li>
                <li className="shape shape-5">
                <img src={PUBLIC_URL + "/images/others/bubble-4.png"} alt="Bubble" />
                </li>
                <li className="shape shape-6">
                <img src={PUBLIC_URL + "/images/others/bubble-30.png"} alt="Bubble" />
                </li>
                <li className="shape shape-7">
                <img src={PUBLIC_URL + "/images/others/bubble-31.png"} alt="Bubble" />
                </li>
