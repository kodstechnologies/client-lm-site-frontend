            ...
            <div className="comment-list">
                <div className="comment">
                    <div className="thumbnail">
                        <img src={PUBLIC_URL + "/images/blog/author-1.png"} alt="Blog Comment" />
                    </div>
                ...
                <div className="comment comment-reply">
                    <div className="thumbnail">
                        <img src={PUBLIC_URL + "/images/blog/author-2.png"} alt="Blog Comment" />
                    </div>
                    <div className="content">
                        <div className="heading">
                ...
                <div className="comment">
                    <div className="thumbnail">
                        <img src={PUBLIC_URL + "/images/blog/author-3.png"} alt="Blog Comment" />
                    </div>
                    <div className="content">
                        <div className="heading">
                            <h5 className="title">Sophie Asveld</h5>
