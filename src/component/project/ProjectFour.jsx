    ...
    return (
        <div className="section section-padding-equal bg-color-dark">
            ...
            <div className="project-add-banner">
                <div className="content">
                    ...
                    <div className="brand-logo">
                        <img src={PUBLIC_URL + "/images/project/godaddy.png"} alt="Godaddy" />
                    </div>
                </div>
                <div className="thumbnail">
                    <img src={PUBLIC_URL + "/images/project/mobile-mockup.png"} alt="Mockup" />
                </div>
            </div>
            ...
            <div className="more-project-btn">
                <Link to={PUBLIC_URL + "/project-grid-two"} className="axil-btn btn-fill-white">Discover More Projects</Link>
            </div>
        </div>
    </div>
    )
